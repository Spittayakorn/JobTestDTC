<?php
    ...
    $sqlAddStatPoint = "
    insert into stationpoint(r_id,r_time,r_lat,r_lon) values('$rId','".getDateTime($time)."','$lat','$lon');";
    $sqlQAddStatPoint = mysqli_query($con,$sqlAddStatPoint);

    if($sqlQAddStatPoint == null)
    {
        echo "คำสั่งผิด1";
    }
